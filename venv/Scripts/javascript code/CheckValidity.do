...
<script type="text/javascript">
 ...
 {
 	window.open("http://medical.buet.ac.bd/web/");
 ...
 function showCASRSite()
 {
  window.open("https://casrproposal.buet.ac.bd/login");
 }
						...
						<tr>
							<td class="search">
								<a href="javascript:showBuetWebMail()"><img
										...
										height="37" border="0" alt="" />
							</td>
						</tr>
						<tr>
							<td>
								<a href="javascript:showCASRSite()" style="padding-left: 5px;font-size: 14px;color: white;font-family:'Times New Roman', Times, serif">CASR Thesis/ Project Proposal</a>s
							</td>
						</tr>
					</table>
				</td>
